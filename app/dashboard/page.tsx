      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        ...
        <div className="flex items-center justify-between space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link href={`/entry/${format(new Date(), 'yyyy-MM-dd')}`}>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList className="bg-primary-dark/80 backdrop-blur-sm">
            <TabsTrigger value="overview" className="text-white data-[state=active]:bg-primary-light/80 data-[state=active]:text-primary-dark">Overview</TabsTrigger>
            <TabsTrigger value="analytics" className="text-white data-[state=active]:bg-primary-light/80 data-[state=active]:text-primary-dark">Analytics</TabsTrigger>
            <TabsTrigger value="journal" className="text-white data-[state=active]:bg-primary-light/80 data-[state=active]:text-primary-dark">Journal</TabsTrigger>
          </TabsList>
